...
public class Date {
    ...
    public Date(String string) {
        ...
        String newMonth = parts[0];
        for (Month currMonth : this.months) {
        ...
        this.string = parts[0] + " " + parts[1] + " | " + parts[2] + " - " + parts[3];
        this.defined = true;
    }
    ...
    private int compMonths(Month lhs, Month rhs) {
